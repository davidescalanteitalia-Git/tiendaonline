      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-3">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-8">
            <h2 className="text-xl font-bold text-slate-800 mb-6">{dict.perfilDeLaTienda}</h2>

            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">{dict.nombreDeLaTienda}</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">{dict.subdominio}</label>
                  <div className="flex">
                    <input
                      type="text"
                      placeholder={dict.placeholderSubdominio}
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">{dict.descripcionCorta}</label>
                <textarea
                  rows="3"
