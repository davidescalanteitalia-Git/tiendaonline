        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-100">
              {/* Plantilla vacía de ejemplo */}
              <tr>
                <td colSpan="4" className="px-6 py-12 text-center text-slate-400">
                  <div className="flex flex-col items-center justify-center">
                    <Package size={48} className="mb-4 text-slate-200" />
                    <p className="font-medium text-slate-600 mb-1">Aún no hay productos</p>
                    <p className="text-sm">Añade tu primer producto para empezar a vender.</p>
                  </div>
                </td>
              </tr>
            </tbody>
